...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=3000&pause=800&color=C77DFF&center=true&vCenter=true&width=650&lines=Hello+World!+I'm+Zoha;C%2B%2B+Developer+%E2%80%A2+Python+Learner;Building+the+Web%2C+One+Bug+at+a+Time;Consistency+beats+perfection." alt="Typing SVG" />

<sub>Static fallback: <code>C++ Developer • Python Learner • Future Web Developer</code></sub>

<br><br>

`Turning logic into code, one sweet commit at a time.` 🍬
...
I'm not a senior anything — I'm a BSCS student who ships small, working things and learns from every one of them.
...
```text
C  →  C++  →  OOP  →  DSA  →  Python  →  HTML/CSS  →  Web Development
✅     ✅       ✅      🔄        🔄          🔄               🔜
```

Every arrow is a phase I've either finished or am actively working through — no skipped steps, no shortcuts.
...
<table>
<tr><td width="30%"><b>Task-Management-System</b></td><td>CLI task manager with color-coded output for priorities, statuses, and due dates</td><td><code>C++</code></td></tr>
<tr><td><b>StudentInfo-Manager-</b></td><td>Command-line manager for handling student records</td><td><code>C++</code></td></tr>
<tr><td><b>Expense-Tracker</b></td><td>A tool for tracking day-to-day expenses</td><td><code>Python</code></td></tr>
<tr><td><b>Python-to-do-list</b></td><td>A simple, practical to-do list app</td><td><code>Python</code></td></tr>
<tr><td><b>Heart</b></td><td>Console program that renders a heart — an early output-formatting exercise</td><td><code>C++</code></td></tr>
</table>
...
My repo list is small on purpose — I'd rather finish a working idea than pile up empty ones. More projects are in progress as I move deeper into Python and web development.
...
Nothing I build works on the first try. That's not a problem to fix — it's the actual process.
...
<!--
  🐍 CONTRIBUTION SNAKE (optional, not embedded above):
  This requires a GitHub Actions workflow running in the blackrose-36/blackrose-36
  profile repo — it can't be generated as a static link in this README.
  Setup: use the platane/snk action to generate contribution-snake.svg on a
  schedule, then reference the generated SVG here once it exists and is live.
-->
